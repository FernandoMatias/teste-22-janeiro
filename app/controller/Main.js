Ext.define('Touch2Demo.controller.Main', {
	...
	refs: {
	    ...
	    configuracaoInicial: {
		xtype: 'configuracaoInicial',
		selector: 'configuracaoInicial',
		autoCreate: true
	    },
	    validacaoInicial: {
		xtype: 'validacaoInicial',
		selector: 'validacaoInicial',
		autoCreate: true
	    },
	    verificaUsuario: {
		xtype: 'verificaUsuario',
		selector: 'verificaUsuario',
		autoCreate: true
	    },
	...
	control: {
	    ...
	    'button[action=sincronizacaoInicial]': {
		tap: 'sincronizacaoInicial'
	    },
	    'button[action=configurarInicial]': {
		tap: 'configuracaoInicial'
	    },
	    'button[action=teste]': {
		tap: 'validacaoInicial'
	    },
	    coletasList: {
    ...
    configuracaoInicial: function () {
	Ext.Viewport.setActiveItem(this.getConfiguracaoInicial());
    },
...
//	salvarColeta.sync();
	...
	var record = store2.getById(1);
	if (record == null) {
	    var form = this.getConfiguracaoInicial(),
		    ip = Ext.create('Touch2Demo.model.IpSincronizar_m', form.getValues()),
		    store2 = Ext.create('Touch2Demo.store.IpSincronizar_s');
	    store2.add(ip);
	} else {
